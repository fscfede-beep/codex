...
impl PidBackend {
    ...
    #[cfg(windows)]
    async fn pid_matches_expected_command(&self, _pid: u32) -> Result<bool> {
        // Windows process identity is validated by the start time and executable
        // handle below; command-line inspection is intentionally omitted.
        Ok(true)
    }
