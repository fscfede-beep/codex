...
pub(crate) fn create_seatbelt_command_args_with_profile(
    ...
    create_seatbelt_command_args_with_delete_fence(
        args,
        profile,
...
pub(crate) fn create_seatbelt_command_args_with_delete_fence(
    args: CreateSeatbeltCommandArgsParams<'_>,
    profile: MacosSeatbeltProfile,
    allowed_symlinked_codex_home: Option<&AbsolutePathBuf>,
    ...
    if deny_file_deletion {
        policy_sections.push("(deny file-write-unlink)".to_string());
    }
